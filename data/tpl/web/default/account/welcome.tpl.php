		...
		<ul>
			...
			<li>
				...
				<div class="banner2_text banner2_text2 poa opacity">
					<p class="p1"><i class="icon3 icon"></i>人人商城:店中店/核中核/O2O分销，电商终结者</p>
					<p class="p2"><i class="icon4 icon"></i>大数据分销:分销终结者，秒杀市场其他分销系统</p>
				</div>
				<div class="banner2_text banner2_text3 poa opacity">
					<p class="p1"><i class="icon5 icon"></i>女神投票:投票系统终结者，内置图片/视频/语音投票</p>
					<p class="p2"><i class="icon6 icon"></i>微小区:实现智慧+生活，内置超市系统</p>
				</div>
			</li>
			<li>
				<a href="#"></a>
			...
			<li>
				...
				<div class="banner4_text poa opacity">
					<p><?php  echo $_W['setting']['copyright']['smname'];?>科技-让世界为您的产品点赞！大数据分销，人人商城，水池分销，全民经纪人<br/>
					等，打造终极分销系统！微商圈，微商场，微生活，微夜店等重磅来袭，<br/>
					打造智慧城市！微拼团，微砍价，微商城，超级店等打造智慧店商！<br/>
					微小区，微餐饮系统，微房产，超市系统，微汽车，微酒店等，<br/>
					打造智慧生活！微信红包，微助力，微现场，场景魔方，女神投票等，<br/>
					打造智慧营销......更多功能期待您的体验！
					</p>
				</div>
			</li>
...
<a href="<?php  echo url('article/news-show/list');?>">客户案例 <span>Case</span></a>
</div>
<ul class="news_list" id="news_list">
...
<a href="#">网站公告 <span>Notice</span></a>
</div>
