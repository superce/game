...
<ul class="nav nav-tabs nav-width">
	<li <?php  if($_GPC['step']==1 || $_GPC['step']=='') { ?>class="active"<?php  } ?> class="normal"><a href="javascript:;">1. 一键获取公众号信息</a></li>
	<li <?php  if($_GPC['step']==2) { ?>class="active"<?php  } ?> class="normal"><a href="javascript:;">2. 设置公众号信息</a></li>
	<li <?php  if($_GPC['step']==3) { ?>class="active"<?php  } ?> class="normal"><a href="javascript:;">3. 设置权限</a></li>
	<li <?php  if($_GPC['step']==4) { ?>class="active"<?php  } ?> class="normal"><a href="javascript:;">4. 引导页面</a></li>
</ul>
<?php  } ?>
...
<div class="clearfix">
	...
	<form action="" method="post"  class="form-horizontal" role="form" enctype="multipart/form-data" id="form1">
		...
		<div class="form-group">
			<div class="col-sm-12">
				...
				<a href="<?php  echo url('account/post-step', array('step' => 2, 'uniacid' => $uniacid))?>" class="btn btn-default" />不获取，直接填写</a>
	...
	<form action="" method="post"  class="form-horizontal" role="form" enctype="multipart/form-data" id="form1">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<p class="form-control-static">在微信公众号请求用户网页授权之前，开发者需要先到公众平台网站的【开发者中心】<b>网页服务</b>中配置授权回调域名。<a href="http://www.012wz.com/wiki" target="_black">查看详情</a></p>
					</div>
				</div>
				<?php  if(!empty($acid)) { ?>
					<div class="form-group">
		...
		<div class="form-group">
			<div class="col-sm-12">
				<a href="<?php  echo url('account/post-step', array('step' => 1, 'uniacid' => $uniacid))?>" class="btn btn-default" />返回上一步</a>
