...
<div class="foot">
<p class="z">
<?php  if(empty($_W['setting']['copyright']['footerleft'])) { ?>Powered by <strong>
<a href="/" target="_blank">012wz.com</a></strong> <em>WEIZAN</em>&nbsp--&copy; 2001-2014 <a href="/" target="_blank"><a href="/" target="_blank">霸途</a>
<?php  } else { ?><?php  echo $_W['setting']['copyright']['footerleft'];?><?php  } ?>
</p>
<p class="y">
<?php  if(empty($_W['setting']['copyright']['footerright'])) { ?>
<a href="http://www.012wz.com/wiki/" >WIKI</a>&nbsp;&nbsp;|&nbsp;&nbsp;
<strong><a href="http://www.012wz.com" target="_blank">霸途科技团队</a></strong>
&nbsp;
( <a href="http://www.miitbeian.gov.cn/" target="_blank">粤ICP备12011035号-12</a> )&nbsp;
