...
<ul class="nav nav-tabs">
	<li<?php  if($do == 'update') { ?> class="active"<?php  } ?>><a href="<?php  echo url('cloud/update');?>">自动更新</a></li>
</ul>
<div class="clearfix">
...
<!--版本信息-->
<div class="box">
	<h3><i class="fa fa-refresh"></i> BATU版本信息</h3>
    ...
    <li>官方网站：<a href="http://www.sogua2008.com" class="blue">BATUSogua2008.com</a></li>

    <li class="red">[当前系统版本]：搜刮霸途V<?php  echo $ver;?></li>
	<?php  if($lastver == $ver) { ?>
	<li class="red">[最新系统版本]：搜刮霸途V<?php  echo $ver;?> （恭喜, 你的程序已经是最新版本）</li>
	<?php  } ?>
	<?php  if($lastver != $ver) { ?>
	<li class="red">[下一个系统版本]：搜刮霸途V<?php  echo $lastver;?> &nbsp;&nbsp;<button onclick="chanage();" class="btn btn-primary">查看版本</button></li>
	<script type="text/javascript">
		function chanage()
		  {
			location = "<?php  echo create_url('cloud/update',array('op'=>'chanage'));?>";
		}
		</script>
	<?php  } ?>
    </div>
	...
	<div class="alert alert-danger">
		 <?php  if($domain_time == '0') { ?><i class="fa fa-exclamation-triangle"></i> 授权版本：授权已过期，请联系QQ:<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=158631386&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:158631386:51" alt="点击这里给我发消息" title="点击这里给我发消息"/></a><!-- WPA Button Begin -->
<script charset="utf-8" type="text/javascript" src="http://wpa.qq.com/msgrd?v=3&uin=158631386&site=qq&menu=yes"></script>
<!-- WPA Button End -->
        <?php  } else { ?>
...
<div class="box">
	<h3><i class="fa fa-refresh"></i> 在线更新日志</h3>
     <div class="alert alert-info" style="line-height:20px;margin-top:8px;">
		请及时留意BATU官网：<a href="http://www.sogua2008.com" target="_blank">www.sogua2008.com</a>
    </div>
</div>
<!--论坛动态end-->
<?php  } ?>
...
<div class="box">
    ...
    <div class="alert alert-info" style="line-height:20px;margin-top:8px;">
	<p class="red"><i class="fa fa-refresh"></i> [待更新的程序版本]：搜刮霸途V<?php  echo $lastver;?> &nbsp;&nbsp;<button onclick="disp_confirm();" class="btn btn-primary" >在线升级</button></p>
	<script type="text/javascript">
		function disp_confirm()
		  ...
		  if (r==true)
			{
			location = "<?php  echo create_url('cloud/update',array('op'=>'update'));?>";
			}
		  }
...
<?php  } ?>
  <div class="col-lg-5">
				<div class="alert alert-info refresh-log">
					<h4><i class="fa fa-bullhorn"></i> 最新功能模块</h4>
