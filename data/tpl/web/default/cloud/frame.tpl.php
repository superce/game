<?php defined('IN_IA') or exit('Access Denied');?><?php  if(!empty($_GPC['a']) && $_GPC['a'] != 'appstore2') { ?>
<?php (!empty($this) && $this instanceof WeModuleSite || 0) ? (include $this->template('common/header-gw', TEMPLATE_INCLUDEPATH)) : (include template('common/header-gw', TEMPLATE_INCLUDEPATH));?>
			...
			<div class="clearfix">
				<iframe src="<?php  echo $iframe;?>" marginheight="0" marginwidth="0" frameborder="0" width="100%" style="height:1050px;" scrolling="no" allowTransparency="true"></iframe>
			</div>
		</div>
	</div>
</div>
...
<?php  } else if(!empty($_GPC['a']) && $_GPC['a'] = 'appstore') { ?>}
...
<iframe src="<?php  echo $iframe;?>" marginheight="0" marginwidth="0" frameborder="0" width="100%" style="height:900px;" scrolling="auto" allowTransparency="true" id="iframe" name="iframe"></iframe>
<style> 
