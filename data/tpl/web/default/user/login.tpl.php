...
<div class="login">
				...
				<form action="" method="post" role="form" id="form1" onsubmit="return formcheck();">
					...
					<div class="form-group">
						<label class="checkbox-inline input-lg">
							<input type="checkbox" value="true" name="rember"> 记住用户名 <font color="red">[请移步‘注册页面’,注册体验-微信公众号服务！]</font>
						</label>
	...
	<div class="center-block footer" role="footer">
		<div class="text-center">
			<?php  if(empty($_W['setting']['copyright']['footerright'])) { ?><a href="http://www.012wz.com">关于霸途</a>&nbsp;&nbsp;<a href="http://bbs.012wz.com">霸途论坛</a>&nbsp;&nbsp;<a href="http://wpa.b.qq.com/cgi/wpa.php?ln=1&key=XzgwMDA4MzA3NV8zMDk2MDdfODAwMDgzMDc1XzJf">联系客服</a><?php  } else { ?><?php  echo $_W['setting']['copyright']['footerright'];?><?php  } ?> &nbsp; &nbsp; <?php  if(!empty($_W['setting']['copyright']['statcode'])) { ?><?php  echo $_W['setting']['copyright']['statcode'];?><?php  } ?>
		</div>
		<div class="text-center">
			<?php  if(empty($_W['setting']['copyright']['footerleft'])) { ?>Powered by <a href="http://www.012wz.com"><b>霸途</b></a> v<?php echo IMS_VERSION;?> &copy; 2014-2015 <a href="http://www.012wz.com">www.012wz.com</a><?php  } else { ?><?php  echo $_W['setting']['copyright']['footerleft'];?><?php  } ?>
		</div>
	</div>
</div>
<script>
